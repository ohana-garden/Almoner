...
echo "🛠️  Starting Part 11: Exposing MCP Endpoint..."

# Rewrite src/server.ts to use the full Almoner instance and expose MCP
echo "📝 Rewriting src/server.ts..."
cat << 'YW_SERVER_FINAL' > src/server.ts
/**
...
# ---------------------------------------------------------
echo "💾 Committing Part 11..."
git add src/server.ts
git commit -m "Refactor: Unified Server & Exposed MCP Endpoint for Agents"
git push origin main

echo "✅ Part 11 Complete! Agent Zero can now connect."
