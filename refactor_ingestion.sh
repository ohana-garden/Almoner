...
echo "🛠️  Starting Part 2: Ingestion Engine Refactor..."

# ---------------------------------------------------------
# STEP 1: Update Schema to index IngestionJob
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# STEP 2: Rewrite Data Ingestion Engine to use DB Persistence
# ---------------------------------------------------------
echo "📝 Rewriting src/modules/data-ingestion/index.ts..."
cat << 'YW_INGEST' > src/modules/data-ingestion/index.ts
/**
...
git add src/modules/graph-core/schema.ts src/modules/data-ingestion/index.ts
git commit -m "Refactor: Hardened Ingestion Engine with DB state persistence"
git push

echo "✅ Part 2 Complete! Ingestion jobs now survive server restarts."
